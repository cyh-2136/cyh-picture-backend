...
import com.cyh.cyhpicturebackend.model.dto.space.*;
...
public class SpaceController {
    ...
    public BaseResponse<Long> addSpace(@RequestBody SpaceAddRequest spaceAddRequest,
        ...
        ThrowUtils.throwIf(spaceAddRequest == null, ErrorCode.PARAMS_ERROR, "空间名称不能为空");
    ...
    public BaseResponse<Boolean> deleteSpace(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 将所有该空间下的图片删除
        boolean pictureResult = pictureService.removeAllBySpaceId(id);
        ThrowUtils.throwIf(!pictureResult, ErrorCode.OPERATION_ERROR, "删除空间下的图片失败");
