...
public class CosManager {
     ...
     * 图片文件后缀
     */
    public static final List<String> FILE_SUFFIX = Arrays.asList("jpg", "jpeg", "png", "gif", "webp");
    ...
    public PutObjectResult putPictureObject(String key, File file) {
        //对key进行处理，判断是否有后缀
        if (!FILE_SUFFIX.contains(FileUtil.getSuffix(key))) {
            key += "jpg";
        }
     ...
     */
    public PutObjectResult putPictureObject(String filePath, java.io.InputStream inputStream, long contentLength) {
        //对key进行处理，判断是否有后缀
        if (!FILE_SUFFIX.contains(FileUtil.getSuffix(filePath))) {
